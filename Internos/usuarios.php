<?php
	...
	// Traemos solo los Usuarios por paginas es decir solo 4 Usuarios por pagina
	$sql_users_pag = "SELECT * FROM usuario ORDER BY tipo LIMIT $iniciar, $usuarios_x_pagina";

<?php 
	...
	$query_dev_val = "SELECT * FROM desarrollador WHERE codigo=$codigo OR nombres='$nombres'";
	...
	<?php
		...
		if (empty($_FILES['imagen2']['name'])) { 
			...
			$query_dev_edit = "UPDATE desarrollador SET nombres='$nombres', apellidos='$apellidos', telefono='$tel', direccion='$direc', codigodepto=$depto, codigomuni=$muni, bio='$bio' WHERE codigo=$codigo OR nombres='$nombres'";
		}else{
			...
			$query_dev_edit = "UPDATE desarrollador SET nombres='$nombres', apellidos='$apellidos', telefono='$tel', direccion='$direc', codigodepto=$depto, codigomuni=$muni, img='$nombre_imagen', bio='$bio' WHERE codigo=$codigo OR nombres='$nombres'";

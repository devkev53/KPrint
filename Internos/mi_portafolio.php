<?php
	...
	function mostrarDevs() {
		...
		$devs = mysqli_query($conn, "SELECT * FROM heroku_59b4c55ab4de36a.desarrollador order by nombres");
	...
	$sql_pros_pag = "SELECT * FROM heroku_59b4c55ab4de36a.proyecto WHERE codigousuario=$user_inline LIMIT $iniciar, $pro_x_pagina";
														    ...
														    <div class="d-flex justify-content-center">
															    ...
															    while ($row_dev = mysqli_fetch_array($q_conn_devs)) {
																	...
																	while ($img_row = mysqli_fetch_array($q_conn_img)) {
																	    echo "<img class='rounded-circle shadow p-1 mr-2 bg-white' width='70' src='uploads/avatares/".$img_row['img']."''></img>";
																    }
															    }

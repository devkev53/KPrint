<?php
	...
	$qs_dev_pro = "SELECT * FROM heroku_59b4c55ab4de36a.desarrollador_proyecto WHERE fk_pro=$codigo";
	...
	while ($row = mysqli_fetch_array($execute_1)) {
		...
		$execute_2 = mysqli_query($conn, "DELETE FROM heroku_59b4c55ab4de36a.desarrollador_proyecto WHERE codigo=$codigo_linea");
	...
	$execute_3 = mysqli_query($conn, "DELETE FROM heroku_59b4c55ab4de36a.proyecto WHERE codigo=$codigo");

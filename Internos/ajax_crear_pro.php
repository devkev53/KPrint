<?php
	...
	$qs_insert = "INSERT INTO proyecto (nombre, descripcion, url_video, fecha_crea, img, codigousuario)
	...
	$query_pro_consult = "SELECT codigo FROM proyecto WHERE nombre='$nombre' AND codigousuario=$codigousuario";
	...
	for ($i=0; $i < count($devs); $i++) {
		$qs_insert = "INSERT INTO desarrollador_proyecto (codigo, fk_dev, fK_pro)

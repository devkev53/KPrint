<?php
	...
	function mostrarDeptos() {
		...
		$deptos = mysqli_query($conn, "SELECT * FROM departamento order by nombre");
	...
	$query_dev = "SELECT * FROM desarrollador";
	...
	$sql_devs_pag = "SELECT * FROM desarrollador LIMIT $iniciar, $dev_x_pagina";

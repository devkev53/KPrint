<?php 
	...
	if (mysqli_num_rows($user_con) > 0) {
		...
		if ($pass1==$pass2) {
			...
			$qs_insert_dev = "INSERT INTO heroku_59b4c55ab4de36a.desarrollador (codigo, nombres, apellidos, telefono, direccion, codigodepto, codigomuni, codigousuario, img, bio)
